namespace Supercell.Laser.Server.Message
{
    ...
    public class CommandManager
    {
        ...
        private bool LogicSelectSkinReceived(LogicSelectSkinCommand command)
        {
            ...
            HomeMode.Home.CharacterId = c.GetGlobalId();
            HomeMode.CharacterChanged.Invoke(c.GetGlobalId());
        ...
        private bool LogicClaimRankUpRewardReceived(LogicClaimRankUpRewardCommand command)
        {
            ...
            {
                string name = $"Goal_{command.MilestoneId}_8_{(command.MilestoneId == 10 ? command.RequieredMilestone : command.RequieredMilestone)}";
